...
const Foods=(food) => {
  let html =`<div class="menu-items col-sm-6">
...
const listKorea =() =>{
   let koreaFoods=""
   menu.map(eleman =>{
    if(eleman.category === "Korea"){
      koreaFoods += Foods(eleman)
    }
   })
...
const listJapan = () =>{
  let japanFoods=""
  menu.map(eleman =>{
    if (eleman.category === "Japan" ) {
      japanFoods += Foods(eleman)
    }
  })
...
const listChina = () =>{
  let chinaFoods=""
  menu.map(eleman=>{
    if(eleman.category === "China")
      chinaFoods += Foods(eleman)
  })
